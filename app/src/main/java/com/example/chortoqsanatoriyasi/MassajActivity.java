...
public class MassajActivity extends AppCompatActivity {
    private TextView txtmail,txtcall,txtfb,txtruy;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_massaj);
        ...
        txtruy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(MassajActivity.this,RuyxatActivity.class);
