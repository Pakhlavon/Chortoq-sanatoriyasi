...
public class InsonOrganizmiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.insonorganizmiactivity);
        ...
        txtruy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(InsonOrganizmiActivity.this,RuyxatActivity.class);
