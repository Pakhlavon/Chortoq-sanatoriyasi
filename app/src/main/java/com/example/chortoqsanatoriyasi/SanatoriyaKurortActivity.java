...
public class SanatoriyaKurortActivity extends AppCompatActivity {
    private TextView txtmail,txtcall,txtfb,txtruy;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sanatoriyakurortactivity);
        ...
        txtruy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(SanatoriyaKurortActivity.this,RuyxatActivity.class);
